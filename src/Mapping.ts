...
type Operation<TSource, TMirror> = (dest: TMirror, value: any, source: TSource) => void;

export class Mapping<TSource, TMirror> {
    private readonly setFieldOperations = new Map<keyof TSource, Operation<TSource, TMirror>[]>();
    ...
    private addSetOperation(property: keyof TSource, operation: Operation<TSource, TMirror>) {
